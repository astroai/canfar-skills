...
- `source-code-first`: Treat current OpenCADC and AstroAI implementation code and
  tests as behavioral truth. Public documentation is orientation and may lag.
...
- `core-vs-extension`: Distinguish OpenCADC core capabilities from optional site
  infrastructure and AstroAI extensions.
